...
// Source: github.com/ozoncp/ocp-remind-api/internal/repo (interfaces: Repo)
...
func (m *MockRepo) Add(arg0 []models.Remind) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) Describe(arg0 uint64) (*models.Remind, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) List(arg0, arg1 uint64) ([]models.Remind, error) {
	m.ctrl.T.Helper()
